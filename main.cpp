...
int main(void)
{
    ...
    InitWindow(screenWidth, screenHeight, "Eat the apples!");
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        BeginDrawing();
            ...
            DrawText(TextFormat("Score %d",score),screenWidth - 190, 50, 20, BLACK);
            if(score>140){


            ClearBackground(RAYWHITE);

            DrawText(TextFormat("The game has ended, I hope you liked it"),screenWidth - 600, 260, 20, BLACK);
